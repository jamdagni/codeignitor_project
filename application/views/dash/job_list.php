          ...
          <thead class="thead-dark">
            ...
            <?php
              ...
              foreach ($job_list->result() as $job) {
                ?>
                <tr>
                  <td><?php echo $job->u_id; ?></td>
                  <td><?php echo $job->name; ?></td>
                  <td><a href="<?php echo site_url();?>jobs/update_job/<?php echo $job->u_id;?>" class="btn btn-warning">Edit</a></td>
                  <td><a href="<?php echo site_url();?>jobs/delete_job/<?php echo $job->u_id;?>" class="btn btn-danger">Delete</a></td>
                </tr>
                <?php
              }
